...
/* Obtenga la fila de resultados como una matriz asociativa. Dado que el conjunto 
de resultados
...
<p>Edite los valores de entrada y envíelos para actualizar el registro del 
empleado.</p>
...
<div class="form-group">
<label>Correo</label>
<input type="text" name="address" class="form-control <?php echo
(!empty($address_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $address; 
?>">
